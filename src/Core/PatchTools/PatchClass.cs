...
namespace SeparatistCrisis.PatchTools
{
    ...
    public abstract class PatchClass
    {
        ...
        public abstract class Patch
        {
            ...
            public void Apply(Harmony harmony)
            {
                ...
                MethodInfo? newMethod = harmony?.Patch(_targetMethod,
            ...
            [Serializable]
            public sealed class PatchCreationException : Exception
            {
                ...
                public PatchCreationException(string message) : base(message)
                {
                }

                public PatchCreationException(string message, Exception innerException) : base(message, innerException)
                {
                }
            }
        }
    ...
    public abstract class PatchClass<TPatch> : PatchClass where TPatch : PatchClass<TPatch>, new()
    {
    ...
    public abstract class PatchClass<TPatch, TTarget> : PatchClass<TPatch> where TPatch : PatchClass<TPatch, TTarget>, new()
    {
