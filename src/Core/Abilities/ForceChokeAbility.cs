...
namespace SeparatistCrisis.Abilities
{
    ...
    public class ForceChokeAbility : BaseAbility
    {
        ...
        public ForceChokeAbility(AbilityAgent abilityAgent, Ability options) : base(abilityAgent, options)
        {
            this._boxLength = 8f;
            this._boxSize = 2f;
        ...
        public override void OnTick(float dt)
        {
            ...
            if (Mission.Current.InputManager.IsKeyDown(TaleWorlds.InputSystem.InputKey.B))
            {
                ...
                {
                    InformationManager.DisplayMessage(new InformationMessage("Force Choke"));
